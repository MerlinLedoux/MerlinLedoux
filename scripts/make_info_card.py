...
# ===========================================================================
HOST = "merlin"   # shown as  merlin@github  in the header

ROWS = [
    ("host",),
    ("kv", "Edu", "Eng., ISIMA - AI & Optimization"),
    ("kv", "Exchange", "HUST, Hanoi (int'l exchange)"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Python, C, C++, Java, JS, MATLAB, SQL"),
    ("kv", "ML / Data", "PyTorch, scikit-learn, pandas, NumPy"),
    ("kv", "Cloud/Infra", "Azure, Docker, Linux/Bash"),
    ("kv", "Tools", "Git, Jupyter, VS Code, Claude Code, Blender"),
]
